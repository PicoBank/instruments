...
func testInstrumentClassesExists(t *testing.T) {
	...
	e, err := InstrumentClassExists(tx, instrumentClass.ID)
	if err != nil {
...
func testInstrumentClassesFind(t *testing.T) {
	...
	instrumentClassFound, err := FindInstrumentClass(tx, instrumentClass.ID)
	if err != nil {
		t.Error(err)
	}
...
func testInstrumentClassToManyInstruments(t *testing.T) {
	...
	b.InstrumentClassID = a.ID
	c.InstrumentClassID = a.ID
...
func testInstrumentClassToManyAddOpInstruments(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if a.ID != first.InstrumentClassID {
			t.Error("foreign key was wrong value", a.ID, first.InstrumentClassID)
		}
		if a.ID != second.InstrumentClassID {
			t.Error("foreign key was wrong value", a.ID, second.InstrumentClassID)
		}
...
var (
	instrumentClassDBTypes = map[string]string{`ID`: `smallint`, `Name`: `character varying`}
	_                      = bytes.MinRead
)
