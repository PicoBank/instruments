...
func testInstrumentsExists(t *testing.T) {
	...
	e, err := InstrumentExists(tx, instrument.ID)
	if err != nil {
...
func testInstrumentsFind(t *testing.T) {
	...
	instrumentFound, err := FindInstrument(tx, instrument.ID)
	if err != nil {
		t.Error(err)
	}
...
func testInstrumentOneToOneSetOpEquityUsingEquity(t *testing.T) {
	...
	for i, x := range []*Equity{&b, &c} {
		...
		if a.ID != x.InstrumentID {
			t.Error("foreign key was wrong value", a.ID, x.InstrumentID)
		}
...
func testInstrumentToManyPayCurrencyEquities(t *testing.T) {
	...
	b.PayCurrencyID.Int = a.ID
	c.PayCurrencyID.Int = a.ID
	if err = b.Insert(tx); err != nil {
		t.Fatal(err)
	}
...
func testInstrumentToManyExerciseCurrencyEquities(t *testing.T) {
	...
	b.ExerciseCurrencyID.Int = a.ID
	c.ExerciseCurrencyID.Int = a.ID
	if err = b.Insert(tx); err != nil {
		t.Fatal(err)
	}
	if err = c.Insert(tx); err != nil {
...
func testInstrumentToManyCompanyCurrencyEquities(t *testing.T) {
	...
	b.CompanyCurrencyID.Int = a.ID
	c.CompanyCurrencyID.Int = a.ID
	if err = b.Insert(tx); err != nil {
		t.Fatal(err)
	}
	if err = c.Insert(tx); err != nil {
...
func testInstrumentToManyCurrencyInstruments(t *testing.T) {
	...
	b.CurrencyID.Int = a.ID
	c.CurrencyID.Int = a.ID
	if err = b.Insert(tx); err != nil {
		t.Fatal(err)
	}
	if err = c.Insert(tx); err != nil {
...
func testInstrumentToManyCurrencyInstrumentJsons(t *testing.T) {
	var err error
	tx := MustTx(boil.Begin())
	defer tx.Rollback()

	var a Instrument
	var b, c InstrumentJSON
	...
	randomize.Struct(seed, &b, instrumentJSONDBTypes, false, instrumentJSONColumnsWithDefault...)
	randomize.Struct(seed, &c, instrumentJSONDBTypes, false, instrumentJSONColumnsWithDefault...)
	...
	instrumentJSON, err := a.CurrencyInstrumentJsons(tx).All()
	if err != nil {
		t.Fatal(err)
	}

	bFound, cFound := false, false
	for _, v := range instrumentJSON {
		if v.CurrencyID.Int == b.CurrencyID.Int {
			bFound = true
		}
		if v.CurrencyID.Int == c.CurrencyID.Int {
	...
	slice := InstrumentSlice{&a}
	if err = a.L.LoadCurrencyInstrumentJsons(tx, false, (*[]*Instrument)(&slice)); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.CurrencyInstrumentJsons); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.CurrencyInstrumentJsons = nil
	if err = a.L.LoadCurrencyInstrumentJsons(tx, true, &a); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.CurrencyInstrumentJsons); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testInstrumentToManyAddOpPayCurrencyEquities(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if a.ID != first.PayCurrencyID.Int {
			t.Error("foreign key was wrong value", a.ID, first.PayCurrencyID.Int)
		}
		if a.ID != second.PayCurrencyID.Int {
			t.Error("foreign key was wrong value", a.ID, second.PayCurrencyID.Int)
		}
...
func testInstrumentToManySetOpPayCurrencyEquities(t *testing.T) {
	...
	if a.ID != d.PayCurrencyID.Int {
		t.Error("foreign key was wrong value", a.ID, d.PayCurrencyID.Int)
	}
	if a.ID != e.PayCurrencyID.Int {
		t.Error("foreign key was wrong value", a.ID, e.PayCurrencyID.Int)
	}
...
func testInstrumentToManyAddOpExerciseCurrencyEquities(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if a.ID != first.ExerciseCurrencyID.Int {
			t.Error("foreign key was wrong value", a.ID, first.ExerciseCurrencyID.Int)
		}
		if a.ID != second.ExerciseCurrencyID.Int {
			t.Error("foreign key was wrong value", a.ID, second.ExerciseCurrencyID.Int)
		}
...
func testInstrumentToManySetOpExerciseCurrencyEquities(t *testing.T) {
	...
	if a.ID != d.ExerciseCurrencyID.Int {
		t.Error("foreign key was wrong value", a.ID, d.ExerciseCurrencyID.Int)
	}
	if a.ID != e.ExerciseCurrencyID.Int {
		t.Error("foreign key was wrong value", a.ID, e.ExerciseCurrencyID.Int)
	}
...
func testInstrumentToManyAddOpCompanyCurrencyEquities(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if a.ID != first.CompanyCurrencyID.Int {
			t.Error("foreign key was wrong value", a.ID, first.CompanyCurrencyID.Int)
		}
		if a.ID != second.CompanyCurrencyID.Int {
			t.Error("foreign key was wrong value", a.ID, second.CompanyCurrencyID.Int)
		}
...
func testInstrumentToManySetOpCompanyCurrencyEquities(t *testing.T) {
	...
	if a.ID != d.CompanyCurrencyID.Int {
		t.Error("foreign key was wrong value", a.ID, d.CompanyCurrencyID.Int)
	}
	if a.ID != e.CompanyCurrencyID.Int {
		t.Error("foreign key was wrong value", a.ID, e.CompanyCurrencyID.Int)
	}
...
func testInstrumentToManyAddOpInstitutionRoles(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if a.ID != first.InstrumentID {
			t.Error("foreign key was wrong value", a.ID, first.InstrumentID)
		}
		if a.ID != second.InstrumentID {
			t.Error("foreign key was wrong value", a.ID, second.InstrumentID)
		}
...
func testInstrumentToManyAddOpCurrencyInstruments(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if a.ID != first.CurrencyID.Int {
			t.Error("foreign key was wrong value", a.ID, first.CurrencyID.Int)
		}
		if a.ID != second.CurrencyID.Int {
			t.Error("foreign key was wrong value", a.ID, second.CurrencyID.Int)
		}
...
func testInstrumentToManySetOpCurrencyInstruments(t *testing.T) {
	...
	if a.ID != d.CurrencyID.Int {
		t.Error("foreign key was wrong value", a.ID, d.CurrencyID.Int)
	}
	if a.ID != e.CurrencyID.Int {
		t.Error("foreign key was wrong value", a.ID, e.CurrencyID.Int)
	}
...
func testInstrumentToManyAddOpCurrencyInstrumentJsons(t *testing.T) {
	var err error
	...
	var a Instrument
	var b, c, d, e InstrumentJSON

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, instrumentDBTypes, false, strmangle.SetComplement(instrumentPrimaryKeyColumns, instrumentColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	foreigners := []*InstrumentJSON{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, instrumentJSONDBTypes, false, strmangle.SetComplement(instrumentJSONPrimaryKeyColumns, instrumentJSONColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*InstrumentJSON{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddCurrencyInstrumentJsons(tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.CurrencyInstrumentJsons[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.CurrencyInstrumentJsons[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.CurrencyInstrumentJsons(tx).Count()
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testInstrumentToManySetOpCurrencyInstrumentJsons(t *testing.T) {
	var err error
	...
	err = a.SetCurrencyInstrumentJsons(tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetCurrencyInstrumentJsons(tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
	...
	if a.R.CurrencyInstrumentJsons[0] != &d {
		t.Error("relationship struct slice not set to correct value")
	}
	if a.R.CurrencyInstrumentJsons[1] != &e {
		t.Error("relationship struct slice not set to correct value")
	}
}

func testInstrumentToManyRemoveOpCurrencyInstrumentJsons(t *testing.T) {
	var err error
	...
	err = a.AddCurrencyInstrumentJsons(tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveCurrencyInstrumentJsons(tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
	...
	if len(a.R.CurrencyInstrumentJsons) != 2 {
		t.Error("should have preserved two relationships")
	}

	// Removal doesn't do a stable deletion for performance so we have to flip the order
	if a.R.CurrencyInstrumentJsons[1] != &d {
		t.Error("relationship to d should have been preserved")
	}
	if a.R.CurrencyInstrumentJsons[0] != &e {
		t.Error("relationship to e should have been preserved")
	}
}
...
func testInstrumentToOneInstrumentClassUsingInstrumentClass(t *testing.T) {
	...
	local.InstrumentClassID = foreign.ID
	if err := local.Insert(tx); err != nil {
		t.Fatal(err)
	}
...
func testInstrumentToOneInstrumentSourceUsingInstrumentSource(t *testing.T) {
	tx := MustTx(boil.Begin())
	defer tx.Rollback()

	var local Instrument
	var foreign InstrumentSource

	seed := randomize.NewSeed()
	if err := randomize.Struct(seed, &local, instrumentDBTypes, false, instrumentColumnsWithDefault...); err != nil {
		t.Errorf("Unable to randomize Instrument struct: %s", err)
	}
	if err := randomize.Struct(seed, &foreign, instrumentSourceDBTypes, false, instrumentSourceColumnsWithDefault...); err != nil {
	...
	local.InstrumentSourceID = foreign.ID
	if err := local.Insert(tx); err != nil {
		t.Fatal(err)
	}

	check, err := local.InstrumentSource(tx).One()
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := InstrumentSlice{&local}
	if err = local.L.LoadInstrumentSource(tx, false, (*[]*Instrument)(&slice)); err != nil {
		t.Fatal(err)
	}
	if local.R.InstrumentSource == nil {
		t.Error("struct should have been eager loaded")
	}

	local.R.InstrumentSource = nil
	if err = local.L.LoadInstrumentSource(tx, true, &local); err != nil {
		t.Fatal(err)
	}
	if local.R.InstrumentSource == nil {
		t.Error("struct should have been eager loaded")
...
func testInstrumentToOneSetOpInstrumentClassUsingInstrumentClass(t *testing.T) {
	...
	for i, x := range []*InstrumentClass{&b, &c} {
		...
		if a.InstrumentClassID != x.ID {
			t.Error("foreign key was wrong value", a.InstrumentClassID, x.ID)
		}
	}
}
func testInstrumentToOneSetOpInstrumentSourceUsingInstrumentSource(t *testing.T) {
	var err error
	...
	var a Instrument
	var b, c InstrumentSource

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, instrumentDBTypes, false, strmangle.SetComplement(instrumentPrimaryKeyColumns, instrumentColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &b, instrumentSourceDBTypes, false, strmangle.SetComplement(instrumentSourcePrimaryKeyColumns, instrumentSourceColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, instrumentSourceDBTypes, false, strmangle.SetComplement(instrumentSourcePrimaryKeyColumns, instrumentSourceColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	...
	for i, x := range []*InstrumentSource{&b, &c} {
		err = a.SetInstrumentSource(tx, i != 0, x)
		if err != nil {
			t.Fatal(err)
		}

		if a.R.InstrumentSource != x {
			t.Error("relationship struct not set to correct value")
		}
		...
		if a.InstrumentSourceID != x.ID {
			t.Error("foreign key was wrong value", a.InstrumentSourceID)
		}

		zero := reflect.Zero(reflect.TypeOf(a.InstrumentSourceID))
		reflect.Indirect(reflect.ValueOf(&a.InstrumentSourceID)).Set(zero)
		...
		if a.InstrumentSourceID != x.ID {
			t.Error("foreign key was wrong value", a.InstrumentSourceID, x.ID)
		}
	}
}
