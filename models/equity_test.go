...
func testEquityToOneInstrumentUsingPayCurrency(t *testing.T) {
	...
	local.PayCurrencyID.Int = foreign.ID
	if err := local.Insert(tx); err != nil {
		t.Fatal(err)
	}
...
func testEquityToOneInstrumentUsingExerciseCurrency(t *testing.T) {
	...
	local.ExerciseCurrencyID.Int = foreign.ID
	if err := local.Insert(tx); err != nil {
		t.Fatal(err)
	}
...
func testEquityToOneInstrumentUsingCompanyCurrency(t *testing.T) {
	...
	local.CompanyCurrencyID.Int = foreign.ID
	if err := local.Insert(tx); err != nil {
		t.Fatal(err)
	}
...
func testEquityToOneSetOpInstrumentUsingPayCurrency(t *testing.T) {
	...
	for i, x := range []*Instrument{&b, &c} {
		...
		if a.PayCurrencyID.Int != x.ID {
			t.Error("foreign key was wrong value", a.PayCurrencyID.Int, x.ID)
		}
	}
}
...
func testEquityToOneSetOpInstrumentUsingExerciseCurrency(t *testing.T) {
	...
	for i, x := range []*Instrument{&b, &c} {
		...
		if a.ExerciseCurrencyID.Int != x.ID {
		...
		if a.ExerciseCurrencyID.Int != x.ID {
			t.Error("foreign key was wrong value", a.ExerciseCurrencyID.Int, x.ID)
		}
	}
}
...
func testEquityToOneSetOpInstrumentUsingCompanyCurrency(t *testing.T) {
	...
	for i, x := range []*Instrument{&b, &c} {
		...
		if a.CompanyCurrencyID.Int != x.ID {
		...
		if a.CompanyCurrencyID.Int != x.ID {
			t.Error("foreign key was wrong value", a.CompanyCurrencyID.Int, x.ID)
		}
	}
}
