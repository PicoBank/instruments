...
type instrumentR struct {
	...
	CurrencyInstrumentJsons  InstrumentJSONSlice
}
...
var (
	instrumentColumns               = []string{"id", "symbol", "name", "description", "instrument_class_id", "instrument_source_id", "currency_id", "from_date", "thru_date", "created_at", "updated_at", "created_by", "updated_by"}
	instrumentColumnsWithoutDefault = []string{"symbol", "name", "description", "instrument_class_id", "instrument_source_id", "currency_id", "from_date", "thru_date", "created_by", "updated_by"}
...
func (o *Instrument) InstrumentClass(exec boil.Executor, mods ...qm.QueryMod) instrumentClassQuery {
	queryMods := []qm.QueryMod{
		qm.Where("id=?", o.InstrumentClassID),
	}
...
func (o *Instrument) InstrumentSourceG(mods ...qm.QueryMod) instrumentSourceQuery {
	return o.InstrumentSource(boil.GetDB(), mods...)
}
...
func (o *Instrument) InstrumentSource(exec boil.Executor, mods ...qm.QueryMod) instrumentSourceQuery {
	queryMods := []qm.QueryMod{
		qm.Where("id=?", o.InstrumentSourceID),
	}

	queryMods = append(queryMods, mods...)

	query := InstrumentSources(exec, queryMods...)
	queries.SetFrom(query.Query, "\"instruments\".\"instrument_source\"")
...
func (o *Instrument) PayCurrencyEquities(exec boil.Executor, mods ...qm.QueryMod) equityQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"instruments\".\"equity\".\"pay_currency_id\"=?", o.ID),
	)
...
func (o *Instrument) ExerciseCurrencyEquities(exec boil.Executor, mods ...qm.QueryMod) equityQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"instruments\".\"equity\".\"exercise_currency_id\"=?", o.ID),
	)
...
func (o *Instrument) InstitutionRoles(exec boil.Executor, mods ...qm.QueryMod) institutionRoleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"instruments\".\"institution_role\".\"instrument_id\"=?", o.ID),
	)
...
func (o *Instrument) CurrencyInstruments(exec boil.Executor, mods ...qm.QueryMod) instrumentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"instruments\".\"instrument\".\"currency_id\"=?", o.ID),
	)
...
func (o *Instrument) CurrencyInstrumentJsonsG(mods ...qm.QueryMod) instrumentJSONQuery {
	return o.CurrencyInstrumentJsons(boil.GetDB(), mods...)
}
...
func (o *Instrument) CurrencyInstrumentJsons(exec boil.Executor, mods ...qm.QueryMod) instrumentJSONQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"instruments\".\"instrument_json\".\"currency_id\"=?", o.ID),
	)

	query := InstrumentJsons(exec, queryMods...)
	queries.SetFrom(query.Query, "\"instruments\".\"instrument_json\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"instruments\".\"instrument_json\".*"})
	}
...
func (instrumentL) LoadInstrumentClass(e boil.Executor, singular bool, maybeInstrument interface{}) error {
	...
	query := fmt.Sprintf(
		"select * from \"instruments\".\"instrument_class\" where \"id\" in (%s)",
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.InstrumentClassID == foreign.ID {
...
// LoadInstrumentSource allows an eager lookup of values, cached into the
// loaded structs of the objects.
func (instrumentL) LoadInstrumentSource(e boil.Executor, singular bool, maybeInstrument interface{}) error {
	var slice []*Instrument
	var object *Instrument
	...
	if singular {
		...
		args[0] = object.InstrumentSourceID
	} else {
		for i, obj := range slice {
			if obj.R == nil {
				obj.R = &instrumentR{}
			}
			args[i] = obj.InstrumentSourceID
		}
	}

	query := fmt.Sprintf(
		"select * from \"instruments\".\"instrument_source\" where \"id\" in (%s)",
		strmangle.Placeholders(dialect.IndexPlaceholders, count, 1, 1),
	)
	...
	results, err := e.Query(query, args...)
	if err != nil {
		return errors.Wrap(err, "failed to eager load InstrumentSource")
	}
	defer results.Close()

	var resultSlice []*InstrumentSource
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice InstrumentSource")
	}
	...
	if singular {
		object.R.InstrumentSource = resultSlice[0]
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.InstrumentSourceID == foreign.ID {
				local.R.InstrumentSource = foreign
				break
			}
		}
	}
...
func (instrumentL) LoadEquity(e boil.Executor, singular bool, maybeInstrument interface{}) error {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.ID == foreign.InstrumentID {
...
func (instrumentL) LoadPayCurrencyEquities(e boil.Executor, singular bool, maybeInstrument interface{}) error {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.PayCurrencyID.Int {
...
func (instrumentL) LoadExerciseCurrencyEquities(e boil.Executor, singular bool, maybeInstrument interface{}) error {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ExerciseCurrencyID.Int {
...
func (instrumentL) LoadCurrencyInstruments(e boil.Executor, singular bool, maybeInstrument interface{}) error {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.CurrencyID.Int {
...
// LoadCurrencyInstrumentJsons allows an eager lookup of values, cached into the
// loaded structs of the objects.
func (instrumentL) LoadCurrencyInstrumentJsons(e boil.Executor, singular bool, maybeInstrument interface{}) error {
	var slice []*Instrument
	var object *Instrument
	...
	query := fmt.Sprintf(
		"select * from \"instruments\".\"instrument_json\" where \"currency_id\" in (%s)",
		strmangle.Placeholders(dialect.IndexPlaceholders, count, 1, 1),
	)
	if boil.DebugMode {
		fmt.Fprintf(boil.DebugWriter, "%s\n%v\n", query, args)
	...
	results, err := e.Query(query, args...)
	if err != nil {
		return errors.Wrap(err, "failed to eager load instrument_json")
	}
	defer results.Close()

	var resultSlice []*InstrumentJSON
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice instrument_json")
	}
	...
	if singular {
		object.R.CurrencyInstrumentJsons = resultSlice
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.CurrencyID.Int {
				local.R.CurrencyInstrumentJsons = append(local.R.CurrencyInstrumentJsons, foreign)
				break
			}
		}
	}
...
func (o *Instrument) SetInstrumentClass(exec boil.Executor, insert bool, related *InstrumentClass) error {
	...
	o.InstrumentClassID = related.ID
...
// SetInstrumentSourceG of the instrument to the related item.
// Sets o.R.InstrumentSource to related.
// Adds o to related.R.Instruments.
// Uses the global database handle.
func (o *Instrument) SetInstrumentSourceG(insert bool, related *InstrumentSource) error {
	return o.SetInstrumentSource(boil.GetDB(), insert, related)
}

// SetInstrumentSourceP of the instrument to the related item.
// Sets o.R.InstrumentSource to related.
// Adds o to related.R.Instruments.
// Panics on error.
func (o *Instrument) SetInstrumentSourceP(exec boil.Executor, insert bool, related *InstrumentSource) {
	if err := o.SetInstrumentSource(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetInstrumentSourceGP of the instrument to the related item.
// Sets o.R.InstrumentSource to related.
// Adds o to related.R.Instruments.
// Uses the global database handle and panics on error.
func (o *Instrument) SetInstrumentSourceGP(insert bool, related *InstrumentSource) {
	if err := o.SetInstrumentSource(boil.GetDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetInstrumentSource of the instrument to the related item.
// Sets o.R.InstrumentSource to related.
// Adds o to related.R.Instruments.
func (o *Instrument) SetInstrumentSource(exec boil.Executor, insert bool, related *InstrumentSource) error {
	...
	o.InstrumentSourceID = related.ID

	if o.R == nil {
		o.R = &instrumentR{
			InstrumentSource: related,
		}
	} else {
		o.R.InstrumentSource = related
	}

	if related.R == nil {
		related.R = &instrumentSourceR{
			Instruments: InstrumentSlice{o},
		}
	} else {
		related.R.Instruments = append(related.R.Instruments, o)
...
func (o *Instrument) SetEquity(exec boil.Executor, insert bool, related *Equity) error {
	...
	if insert {
		...
		values := []interface{}{o.ID, related.InstrumentID}
...
func (o *Instrument) AddPayCurrencyEquities(exec boil.Executor, insert bool, related ...*Equity) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.ID, rel.InstrumentID}
...
func (o *Instrument) AddExerciseCurrencyEquities(exec boil.Executor, insert bool, related ...*Equity) error {
	...
	for _, rel := range related {
		if insert {
			rel.ExerciseCurrencyID.Int = o.ID
...
func (o *Instrument) AddCompanyCurrencyEquities(exec boil.Executor, insert bool, related ...*Equity) error {
	...
	for _, rel := range related {
		if insert {
			rel.CompanyCurrencyID.Int = o.ID
...
func (o *Instrument) AddInstitutionRoles(exec boil.Executor, insert bool, related ...*InstitutionRole) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.ID, rel.InstitutionID, rel.InstrumentID}
...
// AddCurrencyInstrumentJsonsG adds the given related objects to the existing relationships
// of the instrument, optionally inserting them as new records.
// Appends related to o.R.CurrencyInstrumentJsons.
// Sets related.R.Currency appropriately.
// Uses the global database handle.
func (o *Instrument) AddCurrencyInstrumentJsonsG(insert bool, related ...*InstrumentJSON) error {
	return o.AddCurrencyInstrumentJsons(boil.GetDB(), insert, related...)
}

// AddCurrencyInstrumentJsonsP adds the given related objects to the existing relationships
// of the instrument, optionally inserting them as new records.
// Appends related to o.R.CurrencyInstrumentJsons.
// Sets related.R.Currency appropriately.
// Panics on error.
func (o *Instrument) AddCurrencyInstrumentJsonsP(exec boil.Executor, insert bool, related ...*InstrumentJSON) {
	if err := o.AddCurrencyInstrumentJsons(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddCurrencyInstrumentJsonsGP adds the given related objects to the existing relationships
// of the instrument, optionally inserting them as new records.
// Appends related to o.R.CurrencyInstrumentJsons.
// Sets related.R.Currency appropriately.
// Uses the global database handle and panics on error.
func (o *Instrument) AddCurrencyInstrumentJsonsGP(insert bool, related ...*InstrumentJSON) {
	if err := o.AddCurrencyInstrumentJsons(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddCurrencyInstrumentJsons adds the given related objects to the existing relationships
// of the instrument, optionally inserting them as new records.
// Appends related to o.R.CurrencyInstrumentJsons.
// Sets related.R.Currency appropriately.
func (o *Instrument) AddCurrencyInstrumentJsons(exec boil.Executor, insert bool, related ...*InstrumentJSON) error {
	...
	if o.R == nil {
		o.R = &instrumentR{
			CurrencyInstrumentJsons: related,
		}
	} else {
		o.R.CurrencyInstrumentJsons = append(o.R.CurrencyInstrumentJsons, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &instrumentJSONR{
				Currency: o,
			}
		} else {
			rel.R.Currency = o
...
// SetCurrencyInstrumentJsonsG removes all previously related items of the
// instrument replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Currency's CurrencyInstrumentJsons accordingly.
// Replaces o.R.CurrencyInstrumentJsons with related.
// Sets related.R.Currency's CurrencyInstrumentJsons accordingly.
// Uses the global database handle.
func (o *Instrument) SetCurrencyInstrumentJsonsG(insert bool, related ...*InstrumentJSON) error {
	return o.SetCurrencyInstrumentJsons(boil.GetDB(), insert, related...)
}

// SetCurrencyInstrumentJsonsP removes all previously related items of the
// instrument replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Currency's CurrencyInstrumentJsons accordingly.
// Replaces o.R.CurrencyInstrumentJsons with related.
...
func (o *Instrument) SetCurrencyInstrumentJsonsP(exec boil.Executor, insert bool, related ...*InstrumentJSON) {
	if err := o.SetCurrencyInstrumentJsons(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetCurrencyInstrumentJsonsGP removes all previously related items of the
// instrument replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Currency's CurrencyInstrumentJsons accordingly.
// Replaces o.R.CurrencyInstrumentJsons with related.
...
func (o *Instrument) SetCurrencyInstrumentJsonsGP(insert bool, related ...*InstrumentJSON) {
	if err := o.SetCurrencyInstrumentJsons(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetCurrencyInstrumentJsons removes all previously related items of the
// instrument replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Currency's CurrencyInstrumentJsons accordingly.
// Replaces o.R.CurrencyInstrumentJsons with related.
...
func (o *Instrument) SetCurrencyInstrumentJsons(exec boil.Executor, insert bool, related ...*InstrumentJSON) error {
	query := "update \"instruments\".\"instrument_json\" set \"currency_id\" = null where \"currency_id\" = $1"
	values := []interface{}{o.ID}
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, query)
		fmt.Fprintln(boil.DebugWriter, values)
	...
	if o.R != nil {
		for _, rel := range o.R.CurrencyInstrumentJsons {
			rel.CurrencyID.Valid = false
			if rel.R == nil {
				continue
			}
		...
		o.R.CurrencyInstrumentJsons = nil
	}
	return o.AddCurrencyInstrumentJsons(exec, insert, related...)
}

// RemoveCurrencyInstrumentJsonsG relationships from objects passed in.
// Removes related items from R.CurrencyInstrumentJsons (uses pointer comparison, removal does not keep order)
// Sets related.R.Currency.
// Uses the global database handle.
func (o *Instrument) RemoveCurrencyInstrumentJsonsG(related ...*InstrumentJSON) error {
	return o.RemoveCurrencyInstrumentJsons(boil.GetDB(), related...)
}

// RemoveCurrencyInstrumentJsonsP relationships from objects passed in.
// Removes related items from R.CurrencyInstrumentJsons (uses pointer comparison, removal does not keep order)
// Sets related.R.Currency.
// Panics on error.
func (o *Instrument) RemoveCurrencyInstrumentJsonsP(exec boil.Executor, related ...*InstrumentJSON) {
	if err := o.RemoveCurrencyInstrumentJsons(exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveCurrencyInstrumentJsonsGP relationships from objects passed in.
// Removes related items from R.CurrencyInstrumentJsons (uses pointer comparison, removal does not keep order)
// Sets related.R.Currency.
// Uses the global database handle and panics on error.
func (o *Instrument) RemoveCurrencyInstrumentJsonsGP(related ...*InstrumentJSON) {
	if err := o.RemoveCurrencyInstrumentJsons(boil.GetDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveCurrencyInstrumentJsons relationships from objects passed in.
// Removes related items from R.CurrencyInstrumentJsons (uses pointer comparison, removal does not keep order)
// Sets related.R.Currency.
func (o *Instrument) RemoveCurrencyInstrumentJsons(exec boil.Executor, related ...*InstrumentJSON) error {
	...
	for _, rel := range related {
		for i, ri := range o.R.CurrencyInstrumentJsons {
			if rel != ri {
				continue
			}

			ln := len(o.R.CurrencyInstrumentJsons)
			if ln > 1 && i < ln-1 {
				o.R.CurrencyInstrumentJsons[i] = o.R.CurrencyInstrumentJsons[ln-1]
			}
			o.R.CurrencyInstrumentJsons = o.R.CurrencyInstrumentJsons[:ln-1]
			break
		}
	}
...
func FindInstrumentG(id int, selectCols ...string) (*Instrument, error) {
	return FindInstrument(boil.GetDB(), id, selectCols...)
}
...
func FindInstrumentGP(id int, selectCols ...string) *Instrument {
	retobj, err := FindInstrument(boil.GetDB(), id, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func FindInstrument(exec boil.Executor, id int, selectCols ...string) (*Instrument, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"instruments\".\"instrument\" where \"id\"=$1", sel,
	)
...
func FindInstrumentP(exec boil.Executor, id int, selectCols ...string) *Instrument {
	retobj, err := FindInstrument(exec, id, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func (o *Instrument) Delete(exec boil.Executor) error {
	...
	sql := "DELETE FROM \"instruments\".\"instrument\" WHERE \"id\"=$1"
...
func (o *Instrument) Reload(exec boil.Executor) error {
	ret, err := FindInstrument(exec, o.ID)
	if err != nil {
		return err
	}
...
func InstrumentExists(exec boil.Executor, id int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"instruments\".\"instrument\" where \"id\"=$1 limit 1)"
...
func InstrumentExistsP(exec boil.Executor, id int) bool {
	e, err := InstrumentExists(exec, id)
	if err != nil {
		panic(boil.WrapErr(err))
	}
