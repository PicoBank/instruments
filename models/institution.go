...
var (
	institutionColumns               = []string{"id", "name", "description", "acronym", "from_date", "thru_date", "created_at", "created_by", "updated_at", "updated_by"}
	institutionColumnsWithoutDefault = []string{"name", "description", "acronym", "from_date", "thru_date", "created_by", "updated_by"}
	institutionColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
...
func (o *Institution) InstitutionRoles(exec boil.Executor, mods ...qm.QueryMod) institutionRoleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"instruments\".\"institution_role\".\"institution_id\"=?", o.ID),
	)
...
func FindInstitutionG(id int, selectCols ...string) (*Institution, error) {
	return FindInstitution(boil.GetDB(), id, selectCols...)
}
...
func FindInstitutionGP(id int, selectCols ...string) *Institution {
	retobj, err := FindInstitution(boil.GetDB(), id, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func FindInstitution(exec boil.Executor, id int, selectCols ...string) (*Institution, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"instruments\".\"institution\" where \"id\"=$1", sel,
	)
...
func FindInstitutionP(exec boil.Executor, id int, selectCols ...string) *Institution {
	retobj, err := FindInstitution(exec, id, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func (o *Institution) Delete(exec boil.Executor) error {
	...
	sql := "DELETE FROM \"instruments\".\"institution\" WHERE \"id\"=$1"
...
func (o *Institution) Reload(exec boil.Executor) error {
	ret, err := FindInstitution(exec, o.ID)
	if err != nil {
		return err
	}
...
func InstitutionExists(exec boil.Executor, id int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"instruments\".\"institution\" where \"id\"=$1 limit 1)"
...
func InstitutionExistsP(exec boil.Executor, id int) bool {
	e, err := InstitutionExists(exec, id)
	if err != nil {
		panic(boil.WrapErr(err))
	}
