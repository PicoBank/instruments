...
func init() {
	...
	beego.GlobalControllerRouter["github.com/picobank/instruments/controllers:InstitutionController"] = append(beego.GlobalControllerRouter["github.com/picobank/instruments/controllers:InstitutionController"],
