...
CREATE TABLE etl_bats_instrument (
    ...
    periodic_auction_max_duration			        NUMERIC(8),
    periodic_auction_min_order_entry_size	        NUMERIC(8),
    periodic_auction_min_order_entry_notional		NUMERIC(8),
    max_otr_count						            NUMERIC(8),
    max_otr_volume						            NUMERIC(12),
    capped						                    NUMERIC(2),
    venue_cap_percentage						    NUMERIC(8),
